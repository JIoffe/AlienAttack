...
export class MapGeometry {
    ...
    buildCeilingGeometry(gl, mapData, sector) {
        return this.buildHorizontalGeometry(gl, mapData, sector, sector.ceilingz, sector.ceilingheinum);
    }
    buildFloorGeometry(gl, mapData, sector) {
        return this.buildHorizontalGeometry(gl, mapData, sector, sector.floorz, sector.floorheinum);
    }
